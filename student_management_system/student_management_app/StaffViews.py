...
from student_management_app.models import Subjects, SessionYearModel, Students, Attendance, AttendanceReport, StaffAccounts, \
...
def staff_pay(request):
    ...
    staff_name=staff_id.admin.first_name +" "+ staff_id.admin.last_name
    stf_accounts=StaffAccounts.object.filter(staff=staff_id.admin.username)
    return render(request,"staff_template/staff_salary_template.html",{"staff_id":staff_id, "staff_name":staff_name,"stf_accounts":stf_accounts})

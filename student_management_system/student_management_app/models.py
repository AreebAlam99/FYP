...
class StudentAccounts(models.Model):
    ...
    total_amount_student=models.IntegerField(default=0)
    total_paid=models.IntegerField(default=0)
    balance_left=models.IntegerField(default=0)
    account_number=models.CharField(max_length=255, default='Acc Number')
    bank_name=models.CharField(max_length=255, default='Bank Name')
    object=models.Manager()

class StudentAccountsPayment(models.Model):
    id=models.AutoField(primary_key=True)
...
class AddIncomeHead(models.Model):
    id=models.AutoField(primary_key=True)
...
class StaffAccounts(models.Model):
    ...
    amount=models.IntegerField(default=0)
    total_amount_staff=models.IntegerField(default=0)
    total_paid=models.IntegerField(default=0)
    balance_left=models.IntegerField(default=0)
    object=models.Manager()
...
class StaffAccountsPayment(models.Model):
    id=models.AutoField(primary_key=True)
    invoice_id=models.IntegerField(default=0)
    payment=models.IntegerField(default=0)
    date=models.DateField(auto_now_add=True)
...
class AddExpenditureHead(models.Model):
    id=models.AutoField(primary_key=True)
    expenditure_head=models.CharField(max_length=255)
    date=models.DateField(auto_now_add=True)
    comment=models.CharField(max_length=255)
